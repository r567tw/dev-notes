---
title: '原來可以這麼寫(25): 快還要更快'
date: '2023-09-01 00:00:00+08:00'
tags:
- wordpress
---
...
對，沒錯，我其實有時候也是蠻中二屁孩的...，這時候應該要分享一下影片

https://www.youtube.com/watch?v=fJoY4umIf2g


好啦，最近在弄 WordPress 優化，覺得好挫折 QAQ
以前弄自己的部落格在搞`WordPress`時，就已經覺得很慢了，所以才果斷跳到`Hugo`。

沒想到現在在做`WordPress`相關的工作，恩...`出來總是該還的`...

其實我大概也略略知一二一些`WordPress`優化的技巧，所以就把最近`Study`的整理出來讓大家參考，我想這一篇我也會整理到我的`notes`中。

- [Jimmy の note - Wordpress Optimization](https://jimmynotes.netlify.app/docs/php/wordpress/Optimization)
...
## 後話
老實講，一個`Elementor`+`WooCommerce`的`Wordpress`網站，裡面大概裝了2x~3x多外掛，目前我只有能優化到 70 幾分、GTmetrix B 級分數...唉，感覺 #超級挫折的

明明很多方式的應用了, 為啥沒辦法到 A、為啥無法到90幾分...加上有點時間壓力，希望越快完成越好...

加上月初老闆點出進度落後的問題...皮皮挫ing...

> 不過我真的希望，自己能夠成功讓網站快到爆炸 💪

:::success
是不是最近應該開個 104、linkedin 壓壓驚呢?!
:::
